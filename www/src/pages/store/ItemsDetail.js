      ...
      <div>
        <Grid celled="internally" columns="equal" stackable>
          <Grid.Row textAlign="center">
            <Grid.Column>
              <Header as="h1">Item Detail</Header>
            </Grid.Column>
          </Grid.Row>
          ...
          <Grid.Row>
            <Grid.Column>
              <Form size="large">
                <Segment>
                  <Image size="small" floated="left" src={daniel} />

                  <Form.Input fluid type="file" label="Thumbnail preview" />
